...
router.get('/users/:id', validation_1.validateUuidParam, (0, errorHandler_1.asyncHandler)(userController.getById));
router.get('/users/:id/permissions', validation_1.validateUuidParam, (0, errorHandler_1.asyncHandler)(userController.getUserPermissions));
router.put('/users/:id', validation_1.validateUuidParam, (0, errorHandler_1.asyncHandler)(userController.update));
...
router.put('/users/:id/reset-password', validation_1.validateUuidParam, (0, errorHandler_1.asyncHandler)(userController.resetPassword));
router.post('/users', (0, errorHandler_1.asyncHandler)(userController.createUser));
